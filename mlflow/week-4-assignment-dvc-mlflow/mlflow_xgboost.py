...
test_size = xgb_params.pop("test_size")
random_state = xgb_params.pop("random_state")
sales_threshold = xgb_params.pop("sales_threshold")
...
with mlflow.start_run(run_name="XGBoost model"):
    ...
    mlflow.register_model(model_uri=model_uri, name="AdvertisingSalesClassificationXGBoostModel")
    print(f"Model registered in MLflow under name 'AdvertisingSalesClassificationXGBoostModel'")