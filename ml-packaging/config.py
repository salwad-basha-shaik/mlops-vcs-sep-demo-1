...
class ProductionConfig(Config):
    ...
    API_TIMEOUT = 17  # Production has a longer timeout

class DevelopmentConfig(Config):
    DEBUG = True
    LOG_LEVEL = 'DEBUG'
    SECRET_KEY = 'mysecretkey-dev'
    API_TIMEOUT = 18  # Development has a shorter timeout for quick testing

class TestingConfig(Config):
    TESTING = True
    LOG_LEVEL = 'DEBUG'
    SECRET_KEY = 'mysecretkey-test'
    API_TIMEOUT = 19  # Fast timeout for testing
